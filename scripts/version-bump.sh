...
echo "    IMPORTANT: only bump to a RELEASED cyrius version (see"
echo "    https://github.com/MacCracken/cyrius/releases). Pinning to"
echo "    a local-dev or unreleased version causes CI to 404 on the"
echo "    cyrius tarball download — surfaced as patra v1.9.0's"
echo "    first-push CI failure (\"not in gzip format\")."
