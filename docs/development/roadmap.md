...
> **Current**: v1.8.0 — group commit / batched fsync. Three follow-ups from sit's v0.6.4 perf review (1.6.1 → 1.7.0 → 1.7.1 → 1.8.0) are now all shipped. Patra serves libro, vidya, daimon, agnoshi, mela, hoosh, and sit.
