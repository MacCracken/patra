...
- **Source**: ~3,700 lines across 10 modules
- **Tests**: 424 assertions, 2 fuzz harnesses, 24 benchmarks
- **Stable**: 1.5.0 — Whole-tree page reclaim, security audit landed (fixes ship 1.5.1). All numbered roadmap items closed.
